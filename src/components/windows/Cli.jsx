...
Full Stack Developer @ Web Solutions (2020 - 2022)
  ...
  - Designed responsive UIs with React`
        ...
        contact: {
            ...
            usage: 'contact',
            fn: () => `Email: matadeenyadav57@gmail.com
Phone: +91 8153819049
Location: Pune,Maharastra, IN`
        ...
        github: {
            ...
            usage: 'github',
            fn: () => {
                window.open('https://github.com/MatadeenYadav26', '_blank')
        ...
        social: {
            ...
            usage: 'social',
            fn: () => `Twitter: @matadeenyadav
LinkedIn: in/matadeen-yadav-7a87a0301/
Portfolio: matadeenyadav.dev`
        },
        echo: {
